...
@section('content')
                        ...
                        <div class="content-box">
                            ...
                            @if ($item->button_text != '')
                                <div class="btn-box animate-2">
                                    <a href="{{ $item->button_url }}" class="theme-btn btn-style-one hover-light"><span
                                            class="btn-title">{{ $item->button_text }}</span></a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-sm-2 row-cols-md-3 row-cols-xl-5 justify-content-center">
                        @foreach ($services->take($home_1_page_items->service_on_slider_how_many) as $service)
                            <div class="service-block-new-3 at-home6 col wow fadeInUp">
                                <div class="inner-box ">
                                    @if ($service->coustomize_icon)
                                        <img src="{{ 'uploads/' . $service->coustomize_icon }}" class="icon"
                                            alt="">
                                    @else
                                        <i class="icon {{ $service->icon }}"></i>
                                    @endif
                                    <h6 class="title"><a
                                            href="{{ route('service', $service->slug) }}">{{ $service->name }}</a></h6>
                ...
                <div class="row">
                    <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2 wow fadeInRight">
                        <div class="inner-column">
                                ...
                                <div class="info-box">
                                    <div class="inner">
                                        @if ($item->coustomize_icon)
                                            <img class="icon" src="{{ asset('uploads/' . $item->coustomize_icon) }}"
                                                style="height: 78px;" alt="">
                                        @else
                            ...
                            @endforeach
                            <a href="{{ $welcome_one_items->button_url }}" class="theme-btn btn-style-one"><span
                                    class="btn-title">{{ $welcome_one_items->button_text }}</span></a>
                        </div>
                    </div>
                    <div class="image-column col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
                        <div class="image-box">
                            ...
                            <figure class="image-1 wow fadeIn"><img
                                    src="{{ asset('uploads/' . $welcome_one_items->photo1) }}" alt=""></figure>
                            <figure class="image-2 wow fadeIn" data-wow-delay="600ms"><img
                                    src="{{ asset('uploads/' . $welcome_one_items->photo2) }}" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('service', $service->slug) }}"><img
                                                src="{{ asset('uploads/' . $service->photo) }}"
                                                alt="{{ $service->name }}"></a></figure>
                                    <div class="icon-box"><i class="icon {{ $service->icon }}"></i></div>
                                </div>
                                <div class="content-box">
                                    <h5 class="title"><a
                                            href="{{ route('service', $service->slug) }}">{{ $service->name }}</a></h5>
                                    <div class="text">
                                        {!! clean(nl2br($service->short_description)) !!}
                                    </div>
                                    <a href="{{ route('service', $service->slug) }}"
                                        class="read-more">{{ __('Read More') }} <i
                                            class="@if (session('sess_lang_direction') == 'Right to Left (RTL)') fa fa-long-arrow-alt-left @else fa fa-long-arrow-alt-right @endif"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="video-box-new-3">
                    <div class="bg">
                        <div class="bg bg-image"
                            style="background-image: url({{ asset('uploads/' . $video_one_items->photo) }})"></div>
                        <div class="overlay"></div>
                    </div>
                    <div class="content">
                        <div class="btn-box">
                            <a href="https://www.youtube.com/watch?v={{ $video_one_items->youtube_video_id }}"
                                class="play-now" data-fancybox="gallery" data-caption=""><i class="icon fa fa-play"
                                                ...
                                                <div class="content">
                                                    @if ($item->coustomize_icon)
                                                        <img class="icon" src="{{ asset('uploads/' . $item->coustomize_icon) }}"
                                                            alt="">
                                                    @else
                                                        <i class="icon {{ $item->icon }} fz_40"></i>
                                                    @endif
                                                    <div class="count-box"><span class="count-text" data-speed="3000"
                                                            data-stop="{{ $item->number }}">0</span></div>
                ...
                <div class="projects-carousel owl-carousel owl-theme default-navs">
                    @foreach ($portfolios->take($home_1_page_items->portfolio_how_many) as $portfolio)
                        <div class="project-block-home3">
                            <div class="image-box">
                                <figure class="image"><a href="{{ asset('uploads/' . $portfolio->photo) }}"
                                        class="lightbox-image"><img src="{{ asset('uploads/' . $portfolio->photo) }}"
                                            alt=""></a> </figure>
                                <div class="caption-box">
                                    <h4 class="title"><a
                                            href="{{ route('portfolio', $portfolio->slug) }}">{{ $portfolio->name }}</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
    ...
    <div class="statCards variation1" id="statCards">
        <div class="container">
            <div class="content flex-column-reverse flex-md-row">
                <div class="division" id="left">
                    <h1 class="wow fadeInUp animated text-end">88% </h1>
                    <p class="wow fadeInUp animated"> of shoppers want to know about the sustainability of
                        products they
                        purchase.*</p>
                </div>

                <div class="division" id="right"> <img src="{{ asset('dist-front/images/image-66.jpg') }}"
                        class="wow fadeInUp animated">
                </div>
                <img class="shape" src="{{ asset('dist-front/images/image-64.png') }}">
            </div>
        </div>
    </div>
    <div class="statCards variation2 bg-white" id="statCards">
        <div class="container">
            <div class="content flex-column-reverse flex-md-row">
                <div class="division" id="right"> <img src="{{ asset('dist-front/images/image-67.jpg') }}"
                        class="wow fadeInUp animated">
                </div>
                <div class="division" id="left">
                    <h1 class="wow fadeInUp animated text-black">88% </h1>
                    <p class="wow fadeInUp animated  text-black text-end"> of shoppers want to know about the
                        sustainability of products they purchase.*</p>
                </div>
                                ...
                                @if ($global_setting->google_recaptcha_status == 'Show')
                                    <div class="form-group col-lg-12">
                                        <div class="g-recaptcha"
                                            data-sitekey="{{ $global_setting->google_recaptcha_site_key }}"></div>
                                    </div>
                                @endif
                                <div class="form-group col-lg-12">
                                    <button class="theme-btn btn-style-one" type="submit" name="submit-form"><span
                                            class="btn-title">{{ __('Send Message') }}</span></button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <figure class="image"><img
                            src="{{ asset('uploads/' . $home_contact_photos->home_1_contact_photo) }}" alt="">
                    </figure>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    @foreach ($posts->take($home_1_page_items->blog_how_many) as $post)
                        <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="{{ route('post', $post->slug) }}"><img
                                                src="{{ asset('uploads/' . $post->photo) }}" alt=""></a></figure>
                                </div>
                                <div class="content-box">
                                    ...
                                    <a href="{{ route('post', $post->slug) }}" class="read-more">{{ __('Read More') }}
                                        <i
                                            class="@if (session('sess_lang_direction') == 'Right to Left (RTL)') fa fa fa-long-arrow-alt-left @else fa fa-long-arrow-alt-right @endif"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <section class="video-section pull-down">
            ...
            <div class="auto-container">
                <div class="sec-title text-center light">
                    <a href="https://www.youtube.com/watch?v={{ $video_two_items->youtube_video_id }}" class="play-btn"
                        data-fancybox="gallery" data-caption=""><i class="icon fa fa-play" aria-hidden="true"></i></a>
                    <h2>
                    ...
                    <div class="row">
                        <div class="title-column col-lg-3">
                            <div class="inner-column">
                                ...
                                <figure class="image"><img src="{{ asset('uploads/' . $feature_one_items->photo) }}"
                                        alt=""></figure>
                            </div>
                        </div>
                                ...
                                @foreach ($testimonials as $testimonial)
                                    <div class="testimonial-block-home5-v2">
                                        <div class="inner-box">
                                            <div class="content-box">
                                                <div class="thumb"><img
                                                        src="{{ asset('uploads/' . $testimonial->photo) }}"
                                                        alt="">
                                                </div>
                                                <div class="rating">
                                                    @for ($i = 1; $i <= 5; $i++)
                            ...
                            <div class="inner-column wow fadeInLeft">
                                <div class="image-box">
                                    <figure class="image overlay-anim wow fadeInUp"><img
                                            src="{{ asset('uploads/' . $why_choose_one_items->photo) }}" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
