                            ...
                            <select id="iconSelect" name="icon" class="form-select">
                                @foreach ($icons as $icon)
                                    <option value="{{ $icon->icon_code }}"
                                        @if ($icon->icon_code == $service->icon) selected @endif>{{ $icon->icon_code }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" id="coustomize_icon" name="coustomize_icon" class="form-control"
                                accept="image/*">
                            <div id="coustomizeIconPreview">
                                <a href="{{ asset('uploads/' . $service->coustomize_icon) }}" class="magnific"><img
                                    src="{{ asset('uploads/' . $service->coustomize_icon) }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="photo-container">
                                <a href="{{ asset('uploads/' . $service->photo) }}" class="magnific"><img
                                        src="{{ asset('uploads/' . $service->photo) }}" alt=""></a>
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="photo-container">
                                ...
                                @else
                                    <a href="{{ asset('uploads/' . $service->banner) }}" class="magnific"><img
                                            src="{{ asset('uploads/' . $service->banner) }}" alt=""></a>
                                    <div><a href="{{ route('admin_service_destroy_banner', $service->id) }}"
                                            class="text-danger"
                                            onClick="return confirm('{{ __('Are you sure?') }}')">{{ __('Delete Banner') }}</a>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="photo-container">
                                ...
                                @else
                                    <a href="{{ asset('uploads/' . $service->pdf) }}"><img
                                            src="{{ asset('uploads/pdf.svg') }}" alt=""></a>
                                    <div><a href="{{ route('admin_service_destroy_pdf', $service->id) }}"
                                            class="text-danger"
                                            onClick="return confirm('{{ __('Are you sure?') }}')">{{ __('Delete PDF') }}</a>
                                    </div>
                                @endif
                            </div>
                        </div>
