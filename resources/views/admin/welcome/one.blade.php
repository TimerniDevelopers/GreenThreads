                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="photo-container">
                                        <a href="{{ asset('uploads/' . $welcome_one_items->person_photo) }}"
                                            class="magnific"><img
                                                src="{{ asset('uploads/' . $welcome_one_items->person_photo) }}"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="photo-container">
                                        <a href="{{ asset('uploads/' . $welcome_one_items->photo1) }}"
                                            class="magnific"><img
                                                src="{{ asset('uploads/' . $welcome_one_items->photo1) }}"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="photo-container">
                                        <a href="{{ asset('uploads/' . $welcome_one_items->photo2) }}"
                                            class="magnific"><img
                                                src="{{ asset('uploads/' . $welcome_one_items->photo2) }}"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="iconSelect" name="icon" class="form-select">
                                                ...
                                                @foreach ($icons as $icon)
                                                    <option value="{{ $icon->icon_code }}">{{ $icon->icon_code }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <tr>
                                        <td>
                                            @if ($item->coustomize_icon)
                                                <img src="{{ asset('uploads/' . $item->coustomize_icon) }}"
                                                    alt="">
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin_welcome_one_item_element_delete', $item->id) }}"
                                    ...
                                    <div class="modal fade" id="edit_modal_{{ $loop->iteration }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="{{ route('admin_welcome_one_item_element_update', $item->id) }}"
